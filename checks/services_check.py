...
def get_active_services() -> list[str]:
    ...
    try:
        ...
        logger.error("services_check - systemctl - FileNotFoundError")
        pass
    ...
    try:
        ...
        logger.error("services_check - service --status-all - FileNotFoundError")
        pass
...
def services_audit() -> dict:
    ...
    if not active:
        ...
        logger.error("systemctl and service both unavailable")
        return result
